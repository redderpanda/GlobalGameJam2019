...
public class Team_Controller_Script : MonoBehaviour {
    ...
    public static float[] planetGravity = new float[] { 10, 7, 10, 10, 8 };
    public static float[] planetJumpGravity = new float[] { 6, 3, 6, 6, 4 };
	...
	void Update () {
        if (Input.GetKeyDown(KeyCode.LeftShift) && current_character_string == "1")
        {
            avengers_assemble();
        }
